...
function Carrinho() {
  ...
  const listaCarrinho = carrinho.map((produto, index) => (
    <tbody key={produto.id}>
      ...
      <div className="lg:hidden pb-8">
        <img src={produto.fotos[0]} alt="Imagem do Produto" />
        <div className="px-5">
          ...
          <div className="flex items-center justify-between leading-5 pt-3">
            <div>
              ...
              <h3 className="text-md font-semibold">{formatarPreco(produto.preco)}</h3>
            </div>
  ...
  return (
    <>
        ...
        <table className="">
          {/* <thead className="">
            <tr className="bg-gray-100">
              ...
              <th className="px-4 py-2 text-left pl-28">Quantidade</th>
      ...
      <section className="lg:flex lg:justify-between lg:items-center lg:px-44 lg:py-7">
        <div>
        ...
        <div className="text-3xl font-bold flex-col items-center gap-8">
          <p className="text-3xl font-bold">
            <span className="font-normal">Total:</span> {formatarPreco(total)}
          </p>
          <button className="bg-[#1c2bf9] text-white px-4 py-[0.6rem] font-semibold text-lg w-full rounded-xl lg:block mb-8 hover:bg-blue-700">
            Finalizar Compra
          </button>
        </div>
      </section>
